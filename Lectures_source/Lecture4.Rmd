...
One method for controlling the familywise Type I error rate is the _Bonferroni correction_.

- When conduction $K$ hypothesis tests simultaneously, the Bonferroni method adjusts the significance level 
from $\alpha$ to $\alpha / K$.  
